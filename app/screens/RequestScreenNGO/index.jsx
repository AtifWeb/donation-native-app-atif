...
import RequestNgoList from "../../components/RequestNgoList";

const RequestScreenNGO = ({ navigation }) => {
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <RequestNgoList
              ...
              time={item.time}
              onPress={() => navigation.navigate("ConfirmScreenNGO", item)}
            />
          )}
...
export default RequestScreenNGO;
